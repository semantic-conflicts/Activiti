...
public class ActivitiRuleJunit4Test {
    ...
    public void ruleUsageExample() {
        ...
        assertThat(0).isEqualTo(runtimeService.createProcessInstanceQuery().count());
    }
    ...
    public void testWaitForJobs() {
        ...
        assertThat(1).isEqualTo(managementService.createJobQuery().count());

        JobTestHelper.waitForJobExecutorToProcessAllJobs(activitiRule, 5000L, 500L);

        // the job is done
        assertThat(0).isEqualTo(managementService.createJobQuery().count());
    }
