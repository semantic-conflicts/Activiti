...
public class UserTaskActivityBehavior extends TaskActivityBehavior {
  ...
  public void signal(  ActivityExecution execution,  String signalName,  Object signalData) throws Exception {
    if (((ExecutionEntity)execution).getTasks().size() != 0)     throw new ActivitiException("UserTask should not be signalled before complete");
    leave(execution);
  }
  @SuppressWarnings({"unchecked","rawtypes"}) public void handleAssignments(  TaskEntity task,  ActivityExecution execution){
 ...
 * @return 
 */
  public List<String> extractCandidates(  String str){
